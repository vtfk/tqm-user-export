                ...
                $users | ForEach-Object {
                    ...
                    $xml.WriteStartElement("User")
                        ...
                        try {
                            ...
                            # Special case Telemark - Skien tannklinikk
                            if ($user.company -eq "Skien tannklinikk") {
                                $xml.WriteValue("Seksjon tannhelse")
                            } else {
                                if ($user.company) {    
                                    $xml.WriteValue($user.company) # Set ad company as OL3
                                } else {
                                    $xml.WriteValue("BLANK")
                                }
                            }
